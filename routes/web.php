...
Route::get('/locations/{location}/{entityType}/{entity}/materials', [LocationController::class, 'viewEntityMaterials'])
    ->name('locations.view');
Route::get('/locations/{location}/rooms-json', [LocationController::class, 'getRoomsJson'])
    ->name('locations.rooms.json');

Route::get('/locations/{location}/corridors-json', [LocationController::class, 'getCorridorsJson'])
    ->name('locations.corridors.json');
    // Materials
...
Route::get('/locations/{location}/rooms-json', [SiteController::class, 'getRoomsJson']);
Route::get('/locations/{location}/corridors-json', [SiteController::class, 'getCorridorsJson']);
