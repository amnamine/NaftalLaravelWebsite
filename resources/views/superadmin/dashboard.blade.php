        ...
        <div class="bg-white/70 backdrop-blur-lg shadow-2xl rounded-2xl p-8 max-w-7xl mx-auto mt-8 transition-all duration-500 transform hover:scale-[1.01]">
            ...
            <div class="mb-8">
                <div class="animate-slideInLeft">
                    <h1 class="text-2xl md:text-3xl font-bold text-black-900">Bienvenue, <span class="text-yellow-600">{{ Auth::user()?->name ?? 'Utilisateur' }}</span></h1>
                    <p class="text-black-900 mt-1">Tableau de bord <span class="text-xs text-black-900 uppercase tracking-wider">{{ Auth::user()->role }}</span></p>
                </div>
            </div>
